...
namespace AppSale
{
    public partial class AddRegion : ContentPage
    {
        ...
        public async void AddClick(object sender, EventArgs e)
        {
            ...
            regions.WesternCape = Convert.ToInt32(text1Entry.Text);
            regions.Pets = Convert.ToInt32(text2Entry.Text);
            regions.SportsAndOutdoor = Convert.ToInt32(text1Entry.Text);
            ...
            //newItemName.Unfocus();
            await AddItem(regions);
        }

        async Task AddItem(Regions item)
        {
